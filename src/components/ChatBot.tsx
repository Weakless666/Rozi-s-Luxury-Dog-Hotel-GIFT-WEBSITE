...
const ChatBot = () => {
  ...
  const quickQuestions: QuickQuestion[] = [
    ...
    },
    {
      ...
      answer: "Да! Предлагаме професионални груминг услуги - къпане и ресане. Цените започват от 30лв за ресане на малки кучета (до 5кг). Къпане на малки кучета е 35лв, а за гигантски кучета (над 40кг) къпане е 70лв. Всички услуги се извършват от опитни майстори! ✂️"
    },
    {
      id: 10,
    ...
    // 💸 Цени и престой
    {
      ...
      answer: "Луксозното настаняване струва 100лв на нощ. Това включва всички основни услуги. Груминг услугите започват от 30лв за ресане на малки кучета, а за къпане цените са от 35лв (малки) до 70лв (гигантски). Транспортът е 50лв в една посока, само за София и София област. 💰"
    },
    {
      id: 17,
    ...
    },
    {
      ...
      answer: "Цената е 100лв на нощувка и включва всички основни услуги - настаняване, хранене, игри, наблюдение и грижа. Груминг услугите са допълнителни: къпане от 35-70лв, ресане от 30-50лв в зависимост от размера на кучето! 💰"
    },
    {
      id: 55,
    ...
    },
    {
      ...
      answer: "Имаме детайлни цени за груминг услуги: КЪПАНЕ - малки кучета (до 5кг) 35лв, средни (до 15кг) 45лв, големи (до 40кг) 55лв, гигантски (над 40кг) 70лв. РЕСАНЕ - малки 30лв, средни 40лв, големи 45лв, гигантски 50лв. ✂️"
    },
    {
      id: 58,
    ...
    },
    {
      ...
      answer: "Транспортът струва 50лв в една посока. Работим само за София и София област. Имаме безопасни клетки и климатизация! 🚗"
    },
    {
      id: 61,
