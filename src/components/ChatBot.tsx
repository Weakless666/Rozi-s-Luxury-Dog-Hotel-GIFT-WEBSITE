...
const ChatBot = () => {
  ...
  const quickQuestions: QuickQuestion[] = [
    ...
    },
    {
      ...
      answer: "За да проверя наличността за конкретен уикенд, моля свържете се с нас в Instagram или на телефона +359 888 123 456. Ще ви отговорим веднага с актуалната информация! 📞"
    },
    {
      id: 5,
    ...
    },
    {
      ...
      answer: "Да! Предлагаме професионални груминг услуги - къпане, сушене, стрижка, почистване на нокти и уши. Цените започват от 30лв. Всички услуги се извършват от опитни майстори! ✂️"
    },
    {
      id: 10,
    ...
    // 💸 Цени и престой
    {
      ...
      answer: "Луксозното настаняване струва 100лв на ден. Това включва всички основни услуги. Груминг услугите са допълнителни от 30лв, а транспортът от 20лв. За точна цена моля свържете се с нас! 💰"
    },
    {
      id: 17,
    ...
    },
    {
      ...
      answer: "Ако закъснеете, моля уведомете ни веднага! При закъснение над 2 часа се начислява допълнителна такса от 20лв. При спешни случаи винаги се опитваме да бъдем разбиращи! ⏰"
    },
    ...
    // 📍 Местоположение и контакти
    {
      ...
      answer: "Намираме се в Сапарева баня, България на адрес: ул. 'Любов към животните' 123. Имаме лесен достъп с кола и удобно паркиране. Можете да ни намерите в Google Maps! 📍"
    },
    {
      id: 21,
    ...
    },
    {
      ...
      answer: "Нашият телефон за връзка е +359 888 123 456. Можете да ни се обадите на Viber на същия номер. Отговаряме на всички обаждания и съобщения! 📞"
    },
    {
      id: 23,
    ...
    },
    {
      ...
      answer: "Разбира се! Можете да се обаждате по всяко време на +359 888 123 456. Нашият екип винаги е готов да ви отговори и да ви разкаже как се чувства кучето ви! 📞"
    },
    {
      id: 52,
    ...
    },
    {
      ...
      answer: "Цената е 100лв на нощувка и включва всички основни услуги - настаняване, хранене, игри, наблюдение и грижа. Груминг услугите са допълнителни! 💰"
    },
    {
      id: 55,
    ...
    },
    {
      ...
      answer: "Груминг услугите започват от 30лв за основно къпане и достигат до 80лв за пълен груминг със стрижка. Цените зависят от размера и породата на кучето! ✂️"
    },
    {
      id: 58,
    ...
    },
    {
      ...
      answer: "Транспортът струва от 20лв в една посока в рамките на града. За по-далечни разстояния цената се договаря. Имаме безопасни клетки и климатизация! 🚗"
    },
    {
      id: 61,
    ...
    },
    {
      ...
      answer: "Да! Предлагаме транспорт услуги от и до София. Цената се договаря според разстоянието и времето. Имаме безопасни клетки и климатизация! 🚗"
    },
    {
      id: 75,
  ...
  const getBotResponse = (userInput: string): string => {
    ...
    return "Интересен въпрос! 🤔 За по-подробна информация моля свържете се с нас в Instagram (@rozis_luxury_dog_hotel) или на телефона +359 888 123 456. Нашият екип ще ви помогне с всичко!"
  }
