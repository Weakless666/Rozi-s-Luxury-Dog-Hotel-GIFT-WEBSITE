...
const ChatBot = () => {
  ...
  const quickQuestions: QuickQuestion[] = [
    ...
    // 💸 Цени и престой
    {
      ...
      answer: "Луксозното настаняване струва 60€ на нощ. Това включва всички основни услуги. Груминг услугите започват от 15€; къпане от 20€ (малки) до 35€ (гигантски), ресане от 20€ до 35€. Транспортът е 30€ в една посока, само за София и София област. 💰"
    },
    {
      id: 17,
    ...
    },
    {
      ...
      answer: "Цената е 60€ на нощувка и включва всички основни услуги - настаняване, хранене, игри, наблюдение и грижа. Груминг услугите са допълнителни: къпане от 20-35€, ресане от 20-35€ в зависимост от размера на кучето! 💰"
    },
    {
      id: 55,
