...
const AboutPreview = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Професионалисти с безусловна любов към четириногите и години опит в грижата за кучета с най-чисти сърца.'
    },
    {
      icon: Award,
      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              С професионален екип, безгранична любов и грижа, ние създаваме 
              преживяване, което ще накара вашите опашатковци да се чувстват като принцове и принцеси.
            </p>
