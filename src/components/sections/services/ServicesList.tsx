...
const ServicesList = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Пълна грижа за кожата и козината от опитни майстори с най-високи стандарти.',
      features: [
        'Почистване и сушене',
        'Стрижка по поръчка',
        'Почистване на нокти и уши',
        'Козметични процедури',
        'Специални продукти за всеки тип козина'
      ],
      price: 'от 30лв',
    ...
    },
    {
      ...
      description: 'Безопасен транспорт до и от хотела с професионален шофьор и специализирани клетки.',
      features: [
        'Безопасен транспорт',
        'Климатизирани клетки',
