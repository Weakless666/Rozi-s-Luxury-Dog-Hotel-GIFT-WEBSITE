...
const ServicesList = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      features: [
        'Къпане: малки кучета (до 5кг) - 35лв.',
        'Средни кучета (до 15кг) - 45лв.',
        'Големи кучета (до 40 кг) - 55лв.',
        'Гигантски кучета (над 40кг) - 70лв.',
        'Ресане: малки кучета (до 5кг) - 30лв.',
        'Средни кучета (до 15кг) - 40лв.',
        'Големи кучета (до 40 кг) - 45лв.',
        'Гигантски кучета (над 40кг) - 50лв.'
      ],
      price: 'от 35лв',
