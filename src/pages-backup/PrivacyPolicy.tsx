        ...
        >
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg p-8 md:p-12">
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              ...
              <section>
                <h2 className="text-2xl font-elegant font-bold text-gray-800 mb-4">4. Споделяне на информация</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                  ...
                  <li>За защита на нашите права и безопасност</li>
                  <li>С доверени партньори, които ни помагат в работата (със строги договори за поверителност)</li>
                </ul>
              </section>

              <section>
                <h2 className="text-2xl font-elegant font-bold text-gray-800 mb-4">5. Защита на данните</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
                  Използваме индустриални стандарти за защита на вашата информация:
                </p>
                <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
                  <li>SSL криптиране за всички предавания</li>
                  <li>Сигурни сървъри с редовни резервни копия</li>
              ...
              <section>
                <h2 className="text-2xl font-elegant font-bold text-gray-800 mb-4">6. Вашите права (GDPR)</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-elegant font-bold text-gray-800 mb-4">7. Бисквитки (Cookies)</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <section>
                <h2 className="text-2xl font-elegant font-bold text-gray-800 mb-4">9. Промени в политиката</h2>
                <p className="text-gray-700 leading-relaxed">
                  Ние можем да обновяваме тази политика за поверителност от време на време. 
                  Всички промени ще бъдат публикувани на тази страница с дата на последна актуализация.
                </p>
              </section>
            </div>
          </div>
