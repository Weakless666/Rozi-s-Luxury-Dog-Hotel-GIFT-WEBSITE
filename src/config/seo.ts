...
const defaultDescription =
  'Луксозен хотел за кучета в Сапарева баня – настаняване, дневна ясла, транспорт и специализирано хранене. 24/7 грижа, любов и внимание за вашите четириноги приятели.'

export const routeSeo: Record<string, PageSeo> = {
  '/': {
    title: 'Хотел за кучета Сапарева баня | Rozi\'s Luxury Dog Hotel',
